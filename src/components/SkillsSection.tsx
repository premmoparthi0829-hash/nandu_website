...
export const SkillsSection: React.FC = () => {
  ...
  const renderBadge = (name: string, badgeBg?: string, textColor?: string) => {
    ...
    const animClass = "group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-md flex items-center justify-center shrink-0 w-8 h-8 min-[360px]:w-9.5 min-[360px]:h-9.5 sm:w-11 sm:h-11 rounded-xl sm:rounded-2xl font-black text-xs sm:text-base";
    ...
    if (nameLower.includes('photoshop')) {
      return (
        <div className={`${animClass} bg-[#001E36] text-[#31A8FF] border border-sky-400/40 relative overflow-hidden`}>
          <span className="font-extrabold tracking-tight text-sm min-[360px]:text-base sm:text-lg text-[#31A8FF]">Ps</span>
        </div>
      );
    }
    if (nameLower.includes('illustrator')) {
      return (
        <div className={`${animClass} bg-[#331000] text-[#FF9A00] border border-amber-500/40 relative overflow-hidden`}>
          <span className="font-extrabold tracking-tight text-sm min-[360px]:text-base sm:text-lg text-[#FF9A00]">Ai</span>
        </div>
      );
    }
    if (nameLower.includes('indesign')) {
      return (
        <div className={`${animClass} bg-[#2B0017] text-[#FF3366] border border-pink-500/40 relative overflow-hidden`}>
          <span className="font-extrabold tracking-tight text-sm min-[360px]:text-base sm:text-lg text-[#FF3366]">Id</span>
        </div>
      );
    }
    if (nameLower.includes('figma')) {
      return (
        <div className={`${animClass} bg-[#0a0a0a] text-white border border-white/10 group-hover:-rotate-6`}>
          <svg className="w-4 h-4 min-[360px]:w-4.5 min-[360px]:h-4.5 sm:w-5.5 sm:h-5.5" viewBox="0 0 38 57" fill="none">
    ...
    if (nameLower.includes('canva')) {
      return (
        <div className={`${animClass} bg-gradient-to-br from-[#00C4CC] to-[#7D2AE8] text-white shadow-lg border border-cyan-300/30`}>
          <svg className="w-4 h-4 min-[360px]:w-4.5 min-[360px]:h-4.5 sm:w-5 sm:h-5 text-white fill-current" viewBox="0 0 24 24">
    ...
    if (nameLower.includes('photopea')) {
      return (
        <div className={`${animClass} bg-[#182026] border border-emerald-400/40 text-[#00E5FF]`}>
          <svg className="w-4 h-4 min-[360px]:w-4.5 min-[360px]:h-4.5 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="none">
    ...
    if (nameLower.includes('ideogram')) {
      return (
        <div className={`${animClass} bg-[#2A004E] text-[#D8B4FE] border border-purple-400/40`}>
          <svg className="w-4 h-4 min-[360px]:w-4.5 min-[360px]:h-4.5 sm:w-5 sm:h-5 fill-current text-[#D8B4FE]" viewBox="0 0 24 24">
    ...
    if (nameLower.includes('chatgpt')) {
      return (
        <div className={`${animClass} bg-[#064E3B] text-[#34D399] border border-emerald-400/40`}>
          <svg className="w-4 h-4 min-[360px]:w-4.5 min-[360px]:h-4.5 sm:w-5 sm:h-5 fill-current text-[#34D399]" viewBox="0 0 24 24">
    ...
    if (nameLower.includes('firefly')) {
      return (
        <div className={`${animClass} bg-[#3B0A00] text-[#FF5722] border border-orange-500/40 group-hover:rotate-12`}>
          <Flame className="w-4 h-4 min-[360px]:w-4.5 min-[360px]:h-4.5 sm:w-5 sm:h-5 fill-[#FF5722]" />
        </div>
      );
    }
    if (nameLower.includes('gemini') || nameLower.includes('imagen')) {
      return (
        <div className={`${animClass} bg-[#1E1B4B] border border-indigo-400/40`}>
          <svg className="w-4 h-4 min-[360px]:w-4.5 min-[360px]:h-4.5 sm:w-5.5 sm:h-5.5" viewBox="0 0 24 24" fill="none">
    ...
    if (nameLower.includes('veo')) {
      return (
        <div className={`${animClass} bg-[#083344] text-[#38BDF8] border border-sky-400/40`}>
          <svg className="w-4 h-4 min-[360px]:w-4.5 min-[360px]:h-4.5 sm:w-5 sm:h-5 text-[#38BDF8]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    if (nameLower.includes('sora')) {
      return (
        <div className={`${animClass} bg-[#18181B] text-[#F43F5E] border border-rose-500/40`}>
          <svg className="w-4 h-4 min-[360px]:w-4.5 min-[360px]:h-4.5 sm:w-5 sm:h-5 text-[#F43F5E]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    if (nameLower.includes('shutterstock')) {
      return (
        <div className={`${animClass} bg-[#450A0A] text-[#F87171] border border-red-500/40`}>
          <svg className="w-4 h-4 min-[360px]:w-4.5 min-[360px]:h-4.5 sm:w-5 sm:h-5 fill-current text-[#EF4444]" viewBox="0 0 24 24">
    ...
    if (nameLower.includes('adobe stock')) {
      return (
        <div className={`${animClass} bg-[#3F0712] text-[#FB7185] border border-rose-500/40`}>
          <span className="font-extrabold text-xs min-[360px]:text-sm sm:text-base tracking-tight text-[#FB7185]">St</span>
        </div>
      );
    }
    if (nameLower.includes('pexels')) {
      return (
        <div className={`${animClass} bg-[#042F2E] text-[#2DD4BF] border border-teal-400/40`}>
          <svg className="w-4 h-4 min-[360px]:w-4.5 min-[360px]:h-4.5 sm:w-5 sm:h-5 fill-current text-[#2DD4BF]" viewBox="0 0 24 24">
    ...
    if (nameLower.includes('pixabay')) {
      return (
        <div className={`${animClass} bg-[#0F172A] text-[#38BDF8] border border-sky-400/40`}>
          <svg className="w-4 h-4 min-[360px]:w-4.5 min-[360px]:h-4.5 sm:w-5 sm:h-5 fill-current text-[#38BDF8]" viewBox="0 0 24 24">
    ...
    if (nameLower.includes('rawpixel')) {
      return (
        <div className={`${animClass} bg-[#1E1B4B] text-[#A78BFA] border border-purple-400/40`}>
          <span className="font-black text-xs min-[360px]:text-sm sm:text-sm tracking-tight text-[#A78BFA]">rp</span>
        </div>
      );
    }
    if (nameLower.includes('steptodown')) {
      return (
        <div className={`${animClass} bg-[#451A03] text-[#FBBF24] border border-amber-400/40`}>
          <svg className="w-4 h-4 min-[360px]:w-4.5 min-[360px]:h-4.5 sm:w-5 sm:h-5 text-[#FBBF24]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    if (nameLower.includes('freepik')) {
      return (
        <div className={`${animClass} bg-[#0A2540] text-[#38BDF8] border border-blue-400/40`}>
          <svg className="w-4 h-4 min-[360px]:w-4.5 min-[360px]:h-4.5 sm:w-5 sm:h-5 fill-current text-[#0066FF]" viewBox="0 0 24 24">
    ...
    if (nameLower.includes('unsplash')) {
      return (
        <div className={`${animClass} bg-[#111111] text-white border border-white/20`}>
          <svg className="w-4 h-4 min-[360px]:w-4.5 min-[360px]:h-4.5 sm:w-5 sm:h-5 fill-current text-white" viewBox="0 0 24 24">
  ...
  return (
    <section id="skills" className="relative z-10 py-16 sm:py-24 px-4 sm:px-8 md:px-12 bg-[#090909] text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Skills Cards Grid Container — 3 columns on mobile with comfortable spacing */}
        <div className="max-w-6xl mx-auto px-1.5 sm:px-2">
          <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-4 gap-2 min-[400px]:gap-2.5 sm:gap-4.5">
...
const InteractiveSkillCard: React.FC<InteractiveSkillCardProps> = ({ skill, index, renderBadge }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white text-black rounded-xl sm:rounded-2xl px-2 py-3 min-[360px]:px-3 min-[360px]:py-3.5 sm:px-4 sm:py-4 shadow-md sm:shadow-lg hover:shadow-[0_22px_50px_-6px_rgba(136,217,0,0.5)] relative overflow-hidden flex flex-col sm:flex-row items-center justify-center sm:justify-start text-center sm:text-left gap-1.5 min-[360px]:gap-2 sm:gap-3 border border-transparent hover:border-[#88D900] transition-colors duration-300 group cursor-pointer"
    >
      ...
      {/* Middle Text Info — Full name visible without truncation */}
      <div className="flex-1 w-full min-w-0 flex flex-col items-center sm:items-start text-center sm:text-left" style={{ transform: isHovered ? 'translateZ(16px)' : 'translateZ(0px)', transition: 'transform 0.2s' }}>
        <h3 className="font-heading font-extrabold text-[10.5px] min-[360px]:text-[12px] sm:text-base text-slate-900 leading-[1.15] group-hover:text-black whitespace-normal break-words w-full">
          {skill.name}
        </h3>
        <p className="font-body text-[8.5px] min-[360px]:text-[9.5px] sm:text-[11px] text-slate-500 font-medium leading-tight mt-0.5 group-hover:text-slate-700 whitespace-normal break-words w-full hidden min-[320px]:block">
